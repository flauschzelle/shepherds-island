...
function scene:draw()
    ...
    love.graphics.printf("Shepherd's Island", 0, CANVAS_HEIGHT*0.25, CANVAS_WIDTH, "center")
    love.graphics.setFont(bigfont)
    love.graphics.printf("made in 72 hours for Ludum Dare 50", 0, CANVAS_HEIGHT*0.45, CANVAS_WIDTH, "center")
    love.graphics.printf("by flauschzelle and blinry", 0, CANVAS_HEIGHT*0.55, CANVAS_WIDTH, "center")
